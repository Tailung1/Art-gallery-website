  ...
  return (
    <div className='flex flex-col justify-center items-center  h-full'>
      <div className=' relative h-[550px] w-full'>
        <div className='flex h-[72px] absolute'>
          <Link
            to={"/"}
            className='bg-[rgb(213,150,108)] cursor-pointer  w-[56px] h-[72px] flex items-center justify-center'
          >
      ...
      <div className='bg-[#151515] pt-12 pb-14 px-4'>
